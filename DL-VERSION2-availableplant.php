...
<script>
  function showConfirmation() {
    window.open("", "Confirmation", "width=300,height=150");
    setTimeout(function() {
      window.open("", "Confirmation").document.write("<html><head><title>Confirmation</title></head><body><h3>You added it!</h3></body></html>");
    }, 100);
  }

  var radishConfirm = document.getElementsByName("radishConfirm")[0];
  var broccoliConfirm = document.getElementsByName("broccoliConfirm")[0];
  var cabbageConfirm = document.getElementsByName("cabbageConfirm")[0];

  radishConfirm.addEventListener("click", showConfirmation);
  broccoliConfirm.addEventListener("click", showConfirmation);
  cabbageConfirm.addEventListener("click", showConfirmation);
</script>
