...
$sql = "SELECT length_planted FROM plants.presets WHERE preset_id = 2";
...
$sql = "SELECT water_perday FROM plants.presets WHERE preset_id = 2";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT cover_perday FROM plants.presets WHERE preset_id = 2";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT light_perday FROM plants.presets WHERE preset_id = 2";
$result = mysqli_query($conn, $sql);
